...
QT_MOC_LITERAL(1, 12, 9), // "newValued"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "m_seq"
QT_MOC_LITERAL(4, 29, 9) // "m_diceVal"

    },
    "QDiceThread\0newValued\0\0m_seq\0m_diceVal"
};
...
void QDiceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDiceThread::newValued)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QDiceThread::newValued(int _t1, int _t2)
{
